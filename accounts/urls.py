...
urlpatterns = [
    ...
    path('diet_plan/', views.diet_plan, name= 'Plan'),
    #path('diet_aerobics/', views.diet_aerobics, name= 'Aerobics'),
    #path('diet_calisthenics/', views.diet_calisthenics, name= 'Calisthenics'),
    #path('diet_weightlifting/', views.diet_weightlifting, name= 'Weightlifting'),
    #path('diet_yoga/', views.diet_yoga, name= 'Yoga'),
